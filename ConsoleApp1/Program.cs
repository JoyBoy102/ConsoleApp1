...
namespace ConsoleApp1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var table = new ConsoleTable("n", "Приближенное значение", "Точное значение", "K", "Дельта точное", "Дельта Рунге", "Дельта теор.");
            var table2 = new ConsoleTable("n", "Приближенное значение", "K", "Дельта Рунге", "Дельта теор.");
            var table3 = new ConsoleTable("n", "Приближенное значение", "K", "Дельта Рунге", "Дельта теор.");
